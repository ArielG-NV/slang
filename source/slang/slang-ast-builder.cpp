...
{
    return dynamicCast<PtrType>(getPtrType(valueType, addrSpace, coherentScope, "PtrType"));
}
...
RefType* ASTBuilder::getRefType(
    ...
    CoherentScope coherentScope)
{
    return dynamicCast<RefType>(getPtrType(valueType, addrSpace, coherentScope, "RefType"));
}
