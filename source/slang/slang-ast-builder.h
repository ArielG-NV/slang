...
public:
    ...
    PtrType* getPtrType(Type* valueType, AddressSpace addrSpace, CoherentScope coherentScope);
    ...
    RefType* getRefType(Type* valueType, AddressSpace addrSpace, CoherentScope coherentScope);
