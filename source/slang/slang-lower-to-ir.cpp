    ...
    Decl*           decl)
{
    ...
    for(Modifier* mod : decl->modifiers)
    {
        ...
        else if (auto collection = as<MemoryQualifierCollectionModifier>(mod))
        {
            builder->addMemoryQualifierCollectionDecoration(inst, IRIntegerValue(collection->getMemoryQualifierBit()));
        }
